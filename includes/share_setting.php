...
//init optiosn global
	...
	?>
   <div class="wrap">
       <h3 ><a style="font-weight:bold;color:black;" href="https://goo.gl/crjChP">Customize Your Website</a></h3>
       <h2 style="font-weight:bold;color:green;font-size:15px"><?php _e('General Settings'); ?></h2>
            ...
            <table class="form-table">
            	<tbody>
			       ...
			       <table class="form-table">			            
					     <?php settings_fields('smart_post_share_group'); ?>
			            	<tbody>
								<tr>
									<h2 style="font-weight:bold;color:#008EC2;font-size:20px"><?php _e('Facebook Button Settings'); ?></h2>
		            			<th scope="row">
            		 ...
            		 <tr>
						...
						<table class="form-table">			            
					      <?php settings_fields('smart_post_share_group'); ?>
			            	<tbody>
								<tr>
									<h2 style="font-weight:bold;color:#008EC2;font-size:20px"><?php _e('Twitter Button Settings'); ?></h2>
		            			<th scope="row">
				 ...
				 <table class="form-table">			            
					 <?php settings_fields('smart_post_share_group'); ?>
			          <tbody>
		            		<tr>
								<h2 style="font-weight:bold;color:#008EC2;font-size:20px"><?php _e('Google Plus Button Settings'); ?></h2>
	            			<th scope="row">
            		 ...
            		 <tr>
            			...
            			<td>
			            	...
			            	<tbody>
			            		<tr>
									<h2 style="font-weight:bold;color:#008EC2;font-size:20px"><?php _e('Pocket Button Settings'); ?></h2>
		            			<th scope="row">
					 ...
					 <table class="form-table">			            
			            ...
			            <tbody>
		            	<tr>
								<h2 style="font-weight:bold;color:#008EC2;font-size:20px"> <?php _e('LinkedIn Button Settings'); ?></h2>
	            			<th scope="row">
				...
				<table class="form-table">			            
					<?php settings_fields('smart_post_share_group'); ?>
			         <tbody>
	            		<tr>
							<h2 style="font-weight:bold;color:#008EC2;font-size:20px"><?php _e('Email Button Settings'); ?></h2>
            			<th scope="row">
